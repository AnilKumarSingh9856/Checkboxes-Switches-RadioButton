package com.example.checkboxesswitchesradiobutton
...
import com.example.checkboxesswitchesradiobutton.ui.theme.CheckBoxesSwitchesRadioButtonTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            CheckBoxesSwitchesRadioButtonTheme {
